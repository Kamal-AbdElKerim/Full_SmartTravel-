...
?>
    ...
    <div class="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
        <a href="#" class="text-2xl font-bold text-gray-800">Safi - Marakkech</a>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            submitBtn.addEventListener('click', async function() {
                ...
                if (selectedSeat != null && email) {
                    ...
                    window.location.replace(`index.php?action=addReservation&trip_Id=20&number_seat=${selectedSeat.querySelector('span').textContent}&emailClient=${email}`)
                } else {
